...
from backend_Hospital.serializers.medicoSerializer import MedicoSerializer
from backend_Hospital.serializers.usuarioSerializer import UsuarioSerializer
